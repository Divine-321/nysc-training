  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500">Manage your notifications, security, and preferences.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Receive alerts when new courses are assigned.</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Get text messages for exam deadlines.</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#f0f7f3] rounded-2xl shadow-sm border border-green-100 p-6">
            ...
            <p className="text-sm text-green-800 mb-4">If you are experiencing issues with your account, please contact the ICT support desk.</p>
