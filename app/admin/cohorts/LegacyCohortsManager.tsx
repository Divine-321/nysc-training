...
// The dynamic-Cohort admin UI, kept intact for as long as the backend still
// runs the old model. The page switches to TrainingProgrammesManager
// automatically once the restructure is deployed.
export default function LegacyCohortsManager() {
